...
public class FamilyTree {
    ...
    {
        //deleted comments because they were not commented out in the starter file
        int colonIndex = line.indexOf(":");
        if (colonIndex < 0)
        throw new TreeException("Invalid index for : ");
        ...
        else
        {
            ...
            if (parentNode == null){
                throw new TreeException("There is no parent node with that name");
            }
        }
    ...
    TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
    {
        ...
        if (node1 == null)
            throw new TreeException("There is no node here");
